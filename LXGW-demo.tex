...
\def \HoLogo@LXGW#1{%
  \tex_XeTeXcharclass:D "004C = 1% L
  \tex_XeTeXcharclass:D "0058 = 1% X
  \tex_XeTeXcharclass:D "0047 = 1% G
  \tex_XeTeXcharclass:D "0057 = 1% W
...
\date{Released 2025-12-04\quad \texttt{v1.521E}}

\def\Copyright{%
  \begin{center}
  \setlength \fboxrule {1.2pt} \fbox{\setlength \fboxrule {.6pt}%
